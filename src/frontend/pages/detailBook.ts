...
const coverImg      = document.getElementById('book-cover') as HTMLImageElement;
const noCoverEl     = document.getElementById('book-no-cover')!;
const statusEl      = document.getElementById('book-status')!;

const addSection    = document.getElementById('add-to-list-section') as HTMLElement;
const listSelect    = document.getElementById('list-select') as HTMLSelectElement;
const addForm       = document.getElementById('add-to-list-form') as HTMLFormElement;
